  ...
  <section class="relative md:-mt-[76px] not-prose ">
    ...
    <div class="relative max-w-7xl mx-auto px-4 sm:px-6">
      ...
      <div class="py-12 md:py-20 lg:py-0 lg:flex lg:items-center lg:h-screen lg:gap-8">
        ...
        <div class="w-full max-w-[450px] h-auto sm:h-[500px] md:h-[600px] mx-auto">
          <img src="/cooldog.jpeg" alt="Qwind Hero Image (Cool dog)"
            class="w-full h-full object-cover max-w-full drop-shadow-2xl rounded-md" />
        </div>
