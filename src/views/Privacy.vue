<template>
    <section class="px-4 sm:px-6 lg:px-8 py-12 lg:py-20 max-w-3xl mx-auto">
        <div class="prose text-lg leading-5 lg:prose-lg dark:prose-invert prose-headings:font-semibold prose-headings:tracking-tight prose-a:text-blue-600 dark:prose-a:text-blue-400 prose-img:rounded-lg prose-img:shadow-md">
            <h1 class="text-6xl mt-2 leading-relaxed">Privacy Policy</h1>

            <p class="mt-2 leading-relaxed"><em>Last updated</em>: January 06, 2023</p>

            <p class="mt-2 leading-relaxed">This Privacy Policy describes Our policies and procedures on the collection,
            ...
            <p class="mt-2 leading-relaxed">We use Your Personal data to provide and improve the Service. By using the
                Service, You agree to the collection and use of information in accordance with this Privacy Policy. This
                Privacy Policy is just a Demo.</p>

            <h2 class="text-4xl mt-2 leading-relaxed">Interpretation and Definitions</h2>

            <h3 class="text-xl mt-2 leading-relaxed">Interpretation</h3>

            <p class="mt-2 leading-relaxed">The words of which the initial letter is capitalized have meanings defined
                under the following conditions...</p>

            <h3 class="text-xl mt-2 leading-relaxed">Definitions</h3>

            <p class="mt-2 leading-relaxed">For the purposes of this Privacy Policy:</p>

            <ul class="list-disc pl-6 mt-2 leading-relaxed">
                ...
                <li><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this
                    Agreement) refers to Qwind LLC, 1 Cupertino, CA 95014.</li>
                <li><strong>Cookies</strong> are small files placed on Your computer... </li>
                ...
                <li><strong>Website</strong> refers to Qwind, accessible from <a href="https://qwind.pages.dev/"
                        class="text-blue-500 underline">https://qwind.pages.dev/</a></li>
                <li><strong>You</strong> means the individual accessing or using the Service...</li>
            </ul>
            <h2 class="text-4xl mt-2 font-bold leading-relaxed">Collecting and Using Your Personal Data</h2>

            <h3 class="text-xl mt-2 font-bold leading-relaxed">Types of Data Collected</h3>

            <h4 class="text-lg mt-2 font-bold  leading-relaxed">Personal Data</h4>
            <p class="text-lg mt-2 leading-relaxed">While using Our Service, We may ask You to provide Us with certain
            ...
            <h4 class="text-lg mt-2 leading-relaxed">Usage Data</h4>
            <p class="text-lg mt-2 leading-relaxed">Usage Data is collected automatically when using the Service.</p>
            <p class="text-lg mt-2 leading-relaxed">Usage Data may include information such as Your Device's Internet
            ...
            <p class="text-lg mt-2 leading-relaxed">When You access the Service by or through a mobile device, We may
                collect certain information automatically, including, but not limited to, the type of mobile device You
                use, Your mobile device unique ID, the IP address of Your mobile device, Your mobile operating system,
                the type of mobile Internet browser You use, unique device identifiers and other diagnostic data.</p>
            <p class="text-lg mt-2 leading-relaxed">We may also collect information that Your browser sends whenever You
                visit our Service or when You access the Service by or through a mobile device.</p>

            <h4 class="text-lg mt-2 leading-relaxed">Tracking Technologies and Cookies</h4>
            <p class="text-lg mt-2 leading-relaxed">We use Cookies and similar tracking technologies to track the
                activity on Our Service and store certain information. Tracking technologies used are beacons, tags, and
                scripts to collect and track information and to improve and analyze Our Service. The technologies We use
                may include:</p>
            ...
            <p class="text-lg mt-2 leading-relaxed">Cookies can be "Persistent" or "Session" Cookies. Persistent Cookies
            ...
            <p class="text-lg mt-2 leading-relaxed">We use both Session and Persistent Cookies for the purposes set out
                below:</p>

            <ul class="list-disc pl-6 mt-2 leading-relaxed">
                <li><strong>Necessary / Essential Cookies:</strong><br><em>Type:</em> Session
                    Cookies<br><em>Administered by:</em> Us<br><em>Purpose:</em> These Cookies are essential to provide
                ...
                <li><strong>Cookies Policy / Notice Acceptance Cookies:</strong><br><em>Type:</em> Persistent
                    Cookies<br><em>Administered by:</em> Us<br><em>Purpose:</em> These Cookies identify if users have
                    accepted the use of cookies on the Website.</li>
                <li><strong>Functionality Cookies:</strong><br><em>Type:</em> Persistent Cookies<br><em>Administered
                        by:</em> Us<br><em>Purpose:</em> These Cookies allow us to remember choices You make when You
                    use the Website, such as remembering your login details or language preference. The purpose of these
                    Cookies is to provide You with a more personal experience and to avoid You having to re-enter your
                    preferences every time You use the Website.</li>
            </ul>

            <p class="text-lg mt-2 leading-relaxed">For more information about the cookies we use and your choices
                regarding cookies, please visit our Cookies Policy or the Cookies section of our Privacy Policy.</p>

            <h2 class="text-4xl mt-2 leading-relaxed">Use of Your Personal Data</h2>

            <p class="text-lg mt-2 leading-relaxed">The Company may use Personal Data for the following purposes:</p>
            <ul class="list-disc pl-6 mt-2 leading-relaxed">
                ...
                <li><strong>For other purposes:</strong> We may use Your information for other purposes, such as data
                    ...
                    to evaluate and improve our Service, products, services, marketing and your experience.</li>
            </ul>

            <p class="text-lg mt-2 leading-relaxed">We may share Your personal information in the following situations:
            </p>
            <ul class="list-disc pl-6 mt-2 leading-relaxed">
            ...
            <h2 class="text-4xl mt-2 leading-relaxed">Retention of Your Personal Data</h2>
            ...
            <h2 class="text-4xl mt-2 leading-relaxed">Transfer of Your Personal Data</h2>
            <p class="mt-2 text-lg leading-relaxed">Your information, including Personal Data, is processed at the
                Company's
            ...
            <h2 class="text-4xl font-bold mt-2 leading-relaxed">Delete Your Personal Data</h2>
            <p class="mt-2 text-lg leading-relaxed">
            ...
            <h2 class="text-4xl font-bold mt-2 leading-relaxed">Disclosure of Your Personal Data</h2>

            <h3 class="text-2xl font-bold mt-2 leading-relaxed">Business Transactions</h3>
            <p class="mt-2 leading-relaxed">If the Company is involved in a merger, acquisition or asset sale, Your
            ...
            <h4 class="text-lg font-bold mt-2 leading-relaxed">Law enforcement</h4>
            <p class="mt-2 leading-relaxed">Under certain circumstances, the Company may be required to disclose Your
            ...
            <h4 class="text-lg font-bold mt-2 leading-relaxed">Other legal requirements</h4>
            <p class="mt-2 leading-relaxed">The Company may disclose Your Personal Data in the good faith belief that
            ...
            <h2 class="text-4xl mt-2 leading-relaxed">Security of Your Personal Data</h2>
            <p class="mt-2 leading-relaxed">The security of Your Personal Data is important to Us, but remember that no
            ...
            <h2 class="text-4xl mt-2 leading-relaxed">Children's Privacy</h2>
            <p class="mt-2 leading-relaxed">Our Service does not address anyone under the age of 13. We do not knowingly
            ...
            <h2 class="text-4xl mt-2 leading-relaxed">Links to Other Websites</h2>
            <p class="mt-2 leading-relaxed">Our Service may contain links to other websites that are not operated by Us.
            ...
            <h2 class="text-4xl mt-2 leading-relaxed">Changes to this Privacy Policy</h2>
            <p class="mt-2 leading-relaxed">We may update Our Privacy Policy from time to time. We will notify You of
            ...
            <h2 class="text-4xl mt-2 leading-relaxed">Contact Us</h2>
            <p class="mt-2 leading-relaxed">If you have any questions about this Privacy Policy, You can contact us:</p>
            <ul class="list-disc pl-6 mt-2 leading-relaxed">
                <li>By email: somecoolemail@domain.com</li>
            </ul>
        </div>
    </section>
</template>